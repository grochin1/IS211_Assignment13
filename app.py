...
def forgothandling():
    ...
    if person == 'Student':
        ...
        if not f:
            ...
            to = email
            gmail_user = 'projectmaritzais211@gmail.com'
            gmail_pwd = 'Fakepassword1'
...
def updategrades():
    ...
    a =  1 #cr.rowcount
    if a == 0:
        return 'The student did not register the course'
    else:
